...
async fn create_test_app() -> axum::Router {
    ...
    use duckduckgo_mcp_server::mcp_handler::{handle_initialize, handle_list_tools, handle_call_tool, handle_ping};
...
async fn test_mcp_initialize() {
    ...
    assert_eq!(response["result"]["serverInfo"]["name"], "duckduckgo-mcp-server");
}
...
async fn test_health_check_endpoint() {
    ...
    let app = axum::Router::new()
        .route("/health", axum::routing::get(duckduckgo_mcp_server::health_check))
        .with_state(state);
...
async fn test_metrics_endpoint() {
    ...
    let app = axum::Router::new()
        .route("/metrics", axum::routing::get(duckduckgo_mcp_server::metrics))
        .with_state(state);
